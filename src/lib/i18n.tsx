...
const translations: Record<Lang, Dict> = {
  en: {
    ...
    mnt_OTHER: "Other",
    // AI rate-con import
    importRateCon: "Import rate con",
    aiReading: "Reading document…",
    dropRateCon: "Drop rate con to import",
    dropRateConHint: "Image or PDF — AI reads it into a load",
    reviewExtracted: "Review extracted load",
    aiExtractedHint: "AI pre-filled this from your document. Check it before creating.",
    confidence: "Confidence",
    conf_high: "High",
    conf_medium: "Medium",
    conf_low: "Low",
    dupWarnRef: "A load with this reference already exists",
    dupWarnLane: "A similar load on this lane/date exists",
    lowRpmWarn: "Rate is below target",
    target: "target",
    missingFieldsWarn: "Couldn't read these — fill them in",
    createLoadBtn: "Create load",
    aiUnsupportedFile: "Please upload an image or PDF",
    aiNotConfigured: "AI intake isn't configured (missing API key)",
    aiExtractFailed: "Couldn't read the document. Enter the load manually.",
    aiFillRequired: "Fill in ref #, origin and destination",
    needsReview: "Review",
  },
  ru: {
    appName: "Uzlider TMS",
    ...
    mnt_OTHER: "Другое",
    // AI rate-con import
    importRateCon: "Импорт rate con",
    aiReading: "Читаю документ…",
    dropRateCon: "Перетащите rate con",
    dropRateConHint: "Фото или PDF — ИИ создаст груз",
    reviewExtracted: "Проверьте распознанный груз",
    aiExtractedHint: "ИИ заполнил это из документа. Проверьте перед созданием.",
    confidence: "Точность",
    conf_high: "Высокая",
    conf_medium: "Средняя",
    conf_low: "Низкая",
    dupWarnRef: "Груз с таким номером уже существует",
    dupWarnLane: "Похожий груз на этом маршруте/дате уже есть",
    lowRpmWarn: "Ставка ниже целевой",
    target: "цель",
    missingFieldsWarn: "Не распознано — заполните вручную",
    createLoadBtn: "Создать груз",
    aiUnsupportedFile: "Загрузите изображение или PDF",
    aiNotConfigured: "ИИ не настроен (нет API-ключа)",
    aiExtractFailed: "Не удалось прочитать документ. Введите вручную.",
    aiFillRequired: "Заполните номер, пункты отправки и назначения",
  ...
  uz: {
    ...
    mnt_OTHER: "Boshqa",
    // AI rate-con import
    importRateCon: "Rate Con yuklash",
    aiReading: "Hujjat o'qilmoqda…",
    dropRateCon: "Rate Con'ni shu yerga tashlang",
    dropRateConHint: "Rasm yoki PDF — AI yukka aylantiradi",
    reviewExtracted: "O'qilgan yukni tekshiring",
    aiExtractedHint: "AI hujjatdan to'ldirdi. Yaratishdan oldin tekshiring.",
    confidence: "Ishonch",
    conf_high: "Yuqori",
    conf_medium: "O'rta",
    conf_low: "Past",
    dupWarnRef: "Bu raqamli yuk allaqachon mavjud",
    dupWarnLane: "Shu yo'nalish/sanada o'xshash yuk bor",
    lowRpmWarn: "Narx maqsaddan past",
    target: "maqsad",
    missingFieldsWarn: "O'qilmadi — qo'lda to'ldiring",
    createLoadBtn: "Yuk yaratish",
    aiUnsupportedFile: "Rasm yoki PDF yuklang",
    aiNotConfigured: "AI sozlanmagan (API kalit yo'q)",
    aiExtractFailed: "Hujjatni o'qib bo'lmadi. Qo'lda kiriting.",
    aiFillRequired: "Ref #, jo'natish va manzilni to'ldiring",
    needsReview: "Tekshirish",
  },
};
